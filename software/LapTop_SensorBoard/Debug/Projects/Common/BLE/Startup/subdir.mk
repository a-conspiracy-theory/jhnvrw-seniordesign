...
S_SRCS += \
../Projects/Common/BLE/Startup/cpu_context_switch.s 

C_SRCS += \
../Projects/Common/BLE/Startup/device_context_switch.c 

OBJS += \
./Projects/Common/BLE/Startup/cpu_context_switch.o \
./Projects/Common/BLE/Startup/device_context_switch.o 

S_DEPS += \
./Projects/Common/BLE/Startup/cpu_context_switch.d 

C_DEPS += \
./Projects/Common/BLE/Startup/device_context_switch.d 


# Each subdirectory must supply rules for building sources it contributes
Projects/Common/BLE/Startup/%.o: ../Projects/Common/BLE/Startup/%.s Projects/Common/BLE/Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m0plus -g3 -DDEBUG -c -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
Projects/Common/BLE/Startup/%.o Projects/Common/BLE/Startup/%.su Projects/Common/BLE/Startup/%.cyclo: ../Projects/Common/BLE/Startup/%.c Projects/Common/BLE/Startup/subdir.mk
...
clean: clean-Projects-2f-Common-2f-BLE-2f-Startup

clean-Projects-2f-Common-2f-BLE-2f-Startup:
	-$(RM) ./Projects/Common/BLE/Startup/cpu_context_switch.d ./Projects/Common/BLE/Startup/cpu_context_switch.o ./Projects/Common/BLE/Startup/device_context_switch.cyclo ./Projects/Common/BLE/Startup/device_context_switch.d ./Projects/Common/BLE/Startup/device_context_switch.o ./Projects/Common/BLE/Startup/device_context_switch.su

.PHONY: clean-Projects-2f-Common-2f-BLE-2f-Startup
